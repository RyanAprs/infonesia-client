import { User, UserPen, Newspaper, ClipboardList } from "lucide-react";
...
const DashboardAdmin = () => {
  ...
  const list = [
    {
      icon: <User size={54} strokeWidth={1.2} />,
      title: "Pengguna",
      desc: "Kelola data pengguna",
      route: "/admin/pengguna",
    },
    {
      icon: <UserPen size={54} strokeWidth={1.2} />,
      title: "Jurnalis",
      desc: "Kelola data jurnalis",
